...
/*
Tabela auxiliar para incorporar informações adicionais em caso de falha no processo de captura dos dados do STU
*/
...
FROM
  {{ var('aux_sppo_licenciamento_stu_staging') }} as t