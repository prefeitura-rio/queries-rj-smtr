...
-- 4. Filtra viagens distintas (remove duplicação no 1o dia do período,
--    que é sobreposto último do período anterior para considerar viagens que iniciaram no
--    período anterior e terminaram no atual) e adiciona colunas auxiliares
select distinct
    data,
    case
