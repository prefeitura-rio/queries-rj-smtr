SELECT 
  ...
  CASE
      ...
      WHEN data = "2024-02-03" THEN "Sabado - Verão" -- OS de Verão (Despacho MTR-PRO-2024/01534)
      WHEN data = "2024-02-04" THEN "Domingo - Verão" -- OS de Verão (Despacho MTR-PRO-2024/01534)
  ...
  CASE
    ...
    WHEN data BETWEEN DATE(2024,02,03) AND DATE(2024,02,04) THEN DATE(2024,02,02) -- OS de Verão
    -- 2022:
